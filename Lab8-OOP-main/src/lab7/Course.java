...
public class Course {
    ...
    private Map<String, Double> lessonCompletion = new HashMap<>();
    private Map<String, Double> quizAverages = new HashMap<>();
    ...
    public Map<String, Double> getLessonCompletion() { return lessonCompletion;
    }
    public Map<String, Double> getQuizAverages() {return quizAverages;
    }

    public void setLessonCompletion(Map<String, Double> lessonCompletion) {
        this.lessonCompletion = lessonCompletion;
    }

    public void setQuizAverages(Map<String, Double> quizAverages) {
